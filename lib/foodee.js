  ...
  async getOrder (uuid) {
    ...
    const orderDetails = await request({
      ...
      return {
        ...
        'set-menu': null,
        restaurant: {
          ...results.data.included.find(i => i.type === 'restaurants')
            .attributes,
    ...
    const orderMembers = await request({
      ...options,
      url: 'https://www.food.ee/api/v3/orders/105425/group-order-members',
      params: {
        'page[limit]': 300,
        'page[offset]': 0,
        include:
          ...
          return {
            ...
            items: member.relationships['order-items'].data.map(item => {
              ...
              return {
                ...
                ...menuItems[orderItem.relationships['menu-item'].data.id]
              };
            })
          };
        })
